    ...
    return (
        <div className='px-10 sm:px-20'>
            <div className=' text-center mt-15'>
                ...
                <p className='text-center text-neutral-700 my-4'>Your personal shelf of meaningful connections. Browse, tend, and nurture the <br /> relationships that matter most.</p>
